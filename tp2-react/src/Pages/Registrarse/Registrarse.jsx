...
export default function Registrarse() {
  ...
  <h2 className="text-2xl font-bold text-white mb-2">{t('register.title') || 'Registrarse'}</h2>
  
  {/* Fila 1: Nombre y Email en dos columnas si la pantalla es mediana o más grande */}
  ...
  <div className="flex flex-wrap items-center gap-2 text-sm">
    <span className="text-white/60">{t('register.loginMessage')}</span>
    <Link to="/iniciar-sesion" className="text-[#00e5ff] hover:underline transition-all">
